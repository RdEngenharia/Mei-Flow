...
'@
Set-Content -Path "src\components\CnpjOnboarding.tsx" -Value $content -Encoding UTF8
Write-Host "OK: src/components/CnpjOnboarding.tsx criado/atualizado com sucesso."