...
'@
Set-Content -Path "src\components\MeiConfigModal.tsx" -Value $content -Encoding UTF8
Write-Host "OK: src/components/MeiConfigModal.tsx criado/atualizado com sucesso."